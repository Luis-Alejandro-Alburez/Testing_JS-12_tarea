...
function compareGuesses(humano, computadora, objetivo) {
  return Math.abs(humano - objetivo) <= Math.abs(computadora - objetivo);
}
...
updateScore = function (chainString) {
  chainString == "human"
    ? humanScore++
    : chainString == "computer"
    ? computerScore++
...
console.log(generateTarget());
console.log(generateTarget());
console.log(compareGuesses(5, 2, 5));
